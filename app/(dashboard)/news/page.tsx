    ...
    <div className="px-4 md:px-8 pt-6 md:pt-10 pb-12 animate-fade-in">
            ...
            {filteredEvents.map((ev, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    flexShrink: 0,
                    background: isToday ? 'rgba(30,110,255,0.12)' : '#111',
                    border: isToday ? '1px solid rgba(30,110,255,0.35)' : '1px solid rgba(255,255,255,0.07)',
                    borderRadius: 14,
                    padding: '12px 16px',
                    minWidth: 170,
                    maxWidth: 200,
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    {isToday && (
                      <span style={{ fontSize: 9, fontWeight: 700, color: '#4D90FF', fontFamily: 'var(--font-display)', background: 'rgba(30,110,255,0.15)', padding: '2px 7px', borderRadius: 5 }}>TODAY</span>
                    )}
                    {isTomorrow && !isToday && (
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span style={{
                      ...
                      color: isToday ? '#4D90FF' : isTomorrow ? '#fbbf24' : 'rgba(255,255,255,0.3)',
      ...
      {loading ? (
        ...
        <div className="text-center py-24">
          <div style={{ width: 52, height: 52, borderRadius: 16, background: 'rgba(30,110,255,0.08)', border: '1px solid rgba(30,110,255,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
            <Newspaper style={{ width: 22, height: 22, color: 'rgba(30,110,255,0.6)' }} />
          </div>
                    ...
                    {article.tickers?.length > 0 && (
                      <div className="flex flex-wrap gap-1.5 mt-2">
                        {article.tickers.map((ticker) => (
                          <span key={ticker} style={{ fontSize: 10, fontWeight: 600, padding: '2px 7px', borderRadius: 5, background: 'rgba(30,110,255,0.1)', color: '#4D90FF', border: '1px solid rgba(30,110,255,0.2)', fontFamily: 'var(--font-display)' }}>
                            ${ticker}
                          </span>
                        ))}
                      </div>
