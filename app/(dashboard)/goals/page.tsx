...
function DetailCard({
  ...
  const badgePalette =
    ...
    :                    { bg: 'rgba(29,78,216,0.12)',  color: '#a78bfa', border: 'rgba(29,78,216,0.25)' }
          ...
          <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 24, padding: '48px 36px', textAlign: 'center' }}>
            ...
            <div style={{ margin: '0 auto 28px', position: 'relative', width: 96, height: 96 }}>
              <svg width="96" height="96" viewBox="0 0 96 96" fill="none">
                <circle cx="48" cy="48" r="44" stroke="rgba(29,78,216,0.15)" strokeWidth="3" />
                <circle cx="48" cy="48" r="44" stroke="rgba(29,78,216,0.6)" strokeWidth="3" strokeLinecap="round" strokeDasharray="90 186" style={{ transform: 'rotate(-90deg)', transformOrigin: '48px 48px' }} />
                ...
                <circle cx="48" cy="48" r="5" fill="rgba(29,78,216,0.5)" />
              </svg>
              <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Lock style={{ width: 18, height: 18, color: '#3B82F6' }} />
              </div>
            </div>
  ...
  const GOALS_CFG = [
    {
      ...
      badgeBg: pnlPct >= 100 ? 'rgba(52,211,153,0.2)' : pnlPct >= 50 ? 'rgba(52,211,153,0.1)' : 'rgba(29,78,216,0.12)',
    ...
    },
    {
      ...
      badgeBg: wrPct >= 100 ? 'rgba(52,211,153,0.2)' : 'rgba(29,78,216,0.12)',
    ...
    <div className="px-5 md:px-8 pt-6 md:pt-10 pb-10 animate-fade-in">
      ...
      <div className="flex items-start justify-between mb-8">
        ...
        <button
          ...
          style={{ display: 'flex', alignItems: 'center', gap: 7, padding: '9px 16px', borderRadius: 12, background: showForm ? 'rgba(29,78,216,0.15)' : 'rgba(255,255,255,0.05)', border: showForm ? '1px solid rgba(29,78,216,0.3)' : '1px solid rgba(255,255,255,0.08)', color: showForm ? '#3B82F6' : 'rgba(255,255,255,0.5)', fontSize: 12, fontWeight: 600, fontFamily: 'var(--font-display)', cursor: 'pointer', transition: 'all 0.15s' }}
        >
        ...
        <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, overflow: 'hidden', marginBottom: 28 }} className="animate-fade-in">
          ...
          <form onSubmit={handleSave} style={{ padding: '20px 24px' }} className="flex flex-col gap-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="label" style={{ color: '#3B82F6' }}>Win Rate (%)</label>
      ...
      {!hasGoals && !showForm ? (
        ...
        <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 24, padding: '52px 36px', textAlign: 'center', maxWidth: 440 }}>
          <div style={{ margin: '0 auto 24px', position: 'relative', width: 88, height: 88 }}>
            <svg width="88" height="88" viewBox="0 0 88 88" fill="none">
              <circle cx="44" cy="44" r="40" stroke="rgba(29,78,216,0.12)" strokeWidth="3" strokeDasharray="6 6" />
        ...
        <div style={{ maxWidth: 900 }} className="flex flex-col gap-6">
              ...
              <div className="flex items-center gap-6">
                ...
                <div style={{ position: 'relative', flexShrink: 0 }}>
                  <MultiRing rings={[
                    ...
                    { pct: goals?.win_rate_target     ? wrPct  : 0, color: '#3B82F6', r: 60, stroke: 11 },
          ...
          <div className="animate-fade-in" key={activeGoal}>
            ...
            {!active.enabled && (
              <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.07)', borderTop: 'none', borderRadius: '0 0 20px 20px', padding: '40px 24px', textAlign: 'center' }}>
                ...
                <button onClick={() => setShowForm(true)} style={{ marginTop: 12, display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: 12, color: '#3B82F6', fontFamily: 'var(--font-display)', fontWeight: 600, background: 'none', border: 'none', cursor: 'pointer' }}>
          ...
          {/* ── Rules ── */}
          {goals?.notes && (
            <div style={{ background: '#111', border: '1px solid rgba(255,255,255,0.07)', borderLeft: '3px solid rgba(29,78,216,0.5)', borderRadius: 16, padding: '18px 22px' }}>
              <p style={{ fontSize: 10, fontWeight: 700, color: '#3B82F6', fontFamily: 'var(--font-display)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 10 }}>Trading Rules</p>
